...
public class CookieUtil {
    ...
    private static final String P3P_HERDER_VALUE = "CP=\"CURa ADMa DEVa PSAo PSDo OUR BUS UNI PUR INT DEM STA PRE COM NAV OTC NOI DSP COR\"";
    ...
    public static void addCookie(String name, String value, int maxAge, boolean httpOnly, boolean appendP3PHeader, String domain, HttpServletResponse response) {
        ...
        if (appendP3PHeader) {
            response.setHeader("P3P", P3P_HERDER_VALUE);
        }
